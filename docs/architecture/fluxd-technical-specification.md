...
authority. Full restore fixtures require a separately pinned shell/AWK oracle environment; normal
Rust CI does not execute `scripts/rules`, `iptables-restore`, or any live networking command.
