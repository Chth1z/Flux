...
- Added `cargo xtask test-functional-canary-android-x86_64-output-tproxy --serial SERIAL
  ...
  specific mechanism evidence only; production lowering/driver/receipts, distinct UID, Android
