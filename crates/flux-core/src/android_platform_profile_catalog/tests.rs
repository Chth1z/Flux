...
fn behavioral_evidence_digest_is_canonical_and_binds_fresh_context() {
    ...
    assert_eq!(
        ...
        &[
            0xbf, 0xdb, 0x3c, 0xa5, 0xa7, 0x59, 0x3d, 0x71, 0x71, 0x24, 0x8f, 0x98, 0x9c, 0xf1,
            0x97, 0x6d, 0x9d, 0xaa, 0xe9, 0x7c, 0x27, 0x82, 0xfd, 0x83, 0x1a, 0x24, 0xdb, 0x51,
            0x81, 0xc4, 0xef, 0x6e,
        ],
        "schema-v2 evidence bytes must be independent of target pointer width"
    );
    assert_ne!(
