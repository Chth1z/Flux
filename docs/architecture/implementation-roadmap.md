...
7. Complete positive Android mark authority and redesign the RPDB program around the proven no-two-slot/default-network and tethering/per-UID constraints before implementing priority allocation; do not promote legacy low-byte marks, fixed priorities, or transient observed holes without proof.
