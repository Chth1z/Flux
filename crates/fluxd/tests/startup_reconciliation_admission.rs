...
#[test]
fn supported_kernel_rejects_missing_config_before_dispatcher_or_socket_admission() {
    assert_supported_config_failure(ConfigFailureCase::Missing);
}

#[test]
fn supported_kernel_rejects_invalid_config_before_dispatcher_or_socket_admission() {
...
fn assert_supported_config_failure(case: ConfigFailureCase) {
    ...
    assert!(!dispatcher_record.exists(), "dispatcher must not execute");
