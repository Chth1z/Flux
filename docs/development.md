...
prebound outbound-collector integration, and capability-qualified execution remain later
checkpoints. Ingress, REDIRECT/DNAT, counters, route lookups, or a veth bounce cannot qualify
TPROXY.
